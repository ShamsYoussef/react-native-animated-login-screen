...
class CreateOrReuseProvisioningProfileAdhoc {
  constructor(options) {
    ...
    _defineProperty(this, "_distCertSerialNumber", void 0);

    _defineProperty(this, "_udids", void 0);
  ...
  async assignProvisioningProfile(ctx, provisioningProfile) {
    await ctx.ios.updateProvisioningProfile(this._experienceName, this._bundleIdentifier, provisioningProfile, ctx.appleCtx.team);
    (0, _log().default)(_chalk().default.green(`Successfully assigned Provisioning Profile id: ${provisioningProfile.provisioningProfileId} to ${this._experienceName} (${this._bundleIdentifier})`));
  }

  async createOrReuse(ctx) {
    await ctx.ensureAppleCtx();
    const ppManager = new (_provisioningProfileAdhoc().ProvisioningProfileAdhocManager)(ctx.appleCtx);
    return await ppManager.createOrReuse(this._udids, this._bundleIdentifier, this._distCertSerialNumber);
  }
