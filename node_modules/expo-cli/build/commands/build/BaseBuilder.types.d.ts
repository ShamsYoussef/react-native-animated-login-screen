...
export declare type IosOptions = CommonOptions & {
...
export declare type AndroidOptions = CommonOptions & {
    type: 'app-bundle' | 'apk';
    keystorePath?: string;
    keystoreAlias?: string;
    generateKeystore: boolean;
};
export declare type BuilderOptions = Omit<Partial<IosOptions> & Partial<AndroidOptions>, 'type'> & {
    type?: string;
};
