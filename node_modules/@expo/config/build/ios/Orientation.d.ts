...
export declare function getOrientation(config: ExpoConfig): "landscape" | "portrait" | "default" | null;
export declare const PORTRAIT_ORIENTATIONS: string[];
export declare const LANDSCAPE_ORIENTATIONS: string[];
