...
function getUsesNonExemptEncryption(config) {
    var _a, _b;
    return ((_b = (_a = config.ios) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.hasOwnProperty('usesNonExemptEncryption')) ? !!config.ios.config.usesNonExemptEncryption
        : null;
}
exports.getUsesNonExemptEncryption = getUsesNonExemptEncryption;
function setUsesNonExemptEncryption(config, infoPlist) {
