...
export declare function getCustomInfoPlistEntries(config: ExpoConfig): {
    [key: string]: any;
};
export declare function setCustomInfoPlistEntries(config: ExpoConfig, infoPlist: InfoPlist): {
